                                ...
                                <div class="tab-pane fade" id="tab-bottom-left3">
                                    <div class="row">
                                        <form>
                                            ...
                                            <br>
                                            <p>职务：</p>
                                            <select class="form-control" name="" id="roleId">
                                                <option disabled="disabled" value="${user.roleId}">${role}</option>
...
<script type="text/javascript">
    $(function () {
        $("#submitForm").click(function () {
            ...
            alert("提交成功！");
            window.location.href = "${pageContext.request.contextPath }/user/getAllInfo";
        });
    });
</script>
</body>

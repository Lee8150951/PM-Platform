            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="float: right;">
                        <form action="${pageContext.request.contextPath }/assess/queryAssess">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <select class="form-control" name="queryKind" id="queryKind">
                                            ...
                                            <option value="2">第三方评估公司名称</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <nav aria-label="Page navigation">
                                                    <ul class="pagination">
                                                        <li><a href="${pageContext.request.contextPath }/assess/getAllInfo?pn=1">首页</a></li>
                                                        <c:if test="${pageInfo.hasPreviousPage }">
                                                            <li><a href="${pageContext.request.contextPath }/assess/getAllInfo?pn=${pageInfo.pageNum-1}"
                                                        ...
                                                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                            ...
                                                            <c:if test="${page_Num != pageInfo.pageNum }">
                                                                <li><a href="${pageContext.request.contextPath }/assess/getAllInfo?pn=${page_Num }">${page_Num }</a></li>
                                                            </c:if>
                                                        </c:forEach>
                                                        ...
                                                        <li><a href="${pageContext.request.contextPath }/assess/getAllInfo?pn=${pageInfo.pages}">末页</a></li>
                                                    </ul>
                                                </nav>
                                            </div>
                                            <!-- 打印Excel -->
                                            ...
                                            <div class="col-md-2" style="margin-top: 20px;float: right">
                                                <a class="btn btn-success" href="${pageContext.request.contextPath }/assess/excelDown">
                ...
                <div class="row">
                    <div class="col-md-6" style="float:right;">
                        <div style="float:right; margin-right: 30px">
                            <a href="javascript:void(0)" id="showQuery" onclick="show()">时间段查询...</a>
                        </div>
                        <div class="panel" style="position: absolute; width: 95%; display: none" id="queryDiv">
                            <div class="panel-heading">
                                <h3 class="panel-title">时间段查询</h3>
                                <div class="right">
                            ...
                            <div class="panel-body">
                                <form action="${pageContext.request.contextPath }/assess/queryByTimeBucket">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="起始日期" name="beginDate">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="结束时间" name="endDate">
                                        </div>
                                        <div class="col-md-3">

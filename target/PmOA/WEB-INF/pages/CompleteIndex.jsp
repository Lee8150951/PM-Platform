                        ...
                        <div id="fileAdmin" class="collapse in">
                            <ul class="nav">
                                ...
                                <shiro:hasRole name="file">
                                    <li><a href="${pageContext.request.contextPath }/complete/getAllInfo" class="active">未归档企业总览</a></li>
                                </shiro:hasRole>
                            </ul>
                        </div>
                    </li>
...
<div class="main">
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="page-title">未归档企业总览</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center;">扶持金额</th>
                                            <th style="text-align: center;">实施时间</th>
                                            <th style="text-align: center;">完成时间</th>
                                            <th style="text-align: center;">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="complete">
                                            <tr>
                                                <td>${complete.completeId}</td>
                                                <td style="text-align: center;">${complete.completeEnterprise}</td>
                                                <td style="text-align: center;">${complete.completeMan}</td>
                                                <td style="text-align: center;">${complete.completeMoney}</td>
                                                <td style="text-align: center;"><fmt:formatDate value="${complete.completeStarttime}" pattern="yyyy-MM-dd"/></td>
                                                <td style="text-align: center;"><fmt:formatDate value="${complete.completeComtime}" pattern="yyyy-MM-dd"/></td>
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/file/skipToAddFile?completeId=${complete.completeId}"><span class="label label-primary">归档</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/complete/getAllInfo?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/complete/getAllInfo?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/complete/getAllInfo?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/complete/getAllInfo?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!-- 打印Excel -->

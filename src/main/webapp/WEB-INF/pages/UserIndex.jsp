        ...
        <nav>
            <ul class="nav">
                ...
                <shiro:hasRole name="servant">
                    <li><a href="${pageContext.request.contextPath }/user/getAllInfo" class="active"><i class="lnr lnr-chart-bars"></i> <span>权限管理</span></a></li>
                </shiro:hasRole>
                <shiro:hasRole name="servant">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="user">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">${user.unit}</td>
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/user/userDetail?id=${user.id}"><span class="label label-primary">详情</span></a>
                                                    <a href="" onclick="del(${user.id})"><span class="label label-danger">删除</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/user/getAllInfo?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/user/getAllInfo?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/user/getAllInfo?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/user/getAllInfo?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>

...
<div class="main">
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <h3 class="page-title">我的邮件</h3>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-headline">
                        <div class="panel-heading" style="border-bottom: 1px solid #eaeaea;">
                            <h3 class="panel-title">${email.emailHead}</h3>
                            <p class="panel-subtitle" style="margin-top:5px;">发件人：<strong style="color: #0081c2;">${email.emailSend}</strong></p>
                            <p class="panel-subtitle" style="margin-top:5px;">收件人：<strong style="color: #0081c2;">${email.emailGet}</strong></p>
                            <p class="panel-subtitle" style="margin-top:5px;">
                                时&nbsp;&nbsp;&nbsp;间：<fmt:formatDate value="${email.emailTime}" pattern="yyyy-MM-dd"/>
                            </p>
                        </div>

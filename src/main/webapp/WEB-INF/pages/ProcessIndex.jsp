        ...
        <nav>
            <ul class="nav">
                ...
                <shiro:hasAnyRoles name="servant, leader">
                    <li><a href="${pageContext.request.contextPath }/process/getAllProcess" class="active"><i class="lnr lnr-pushpin"></i> <span>在办业务</span></a></li>
                </shiro:hasAnyRoles>
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center;">进程负责人</th>
                                            <th style="text-align: center;">开始时间</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="process">
                                            <tr>
                                                <td>${process.ID_}</td>
                                                <td style="text-align: center;">${process.NAME_}</td>
                                                <td style="text-align: center;">${process.ASSIGNEE_}</td>
                                                <td style="text-align: center;">${process.CREATE_TIME_}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/process/getAllProcess?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/process/getAllProcess?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/process/getAllProcess?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/process/getAllProcess?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!-- 打印Excel -->
                                        ...
                                        <div class="col-md-2" style="margin-top: 20px;float: right">
                                            <a class="btn btn-success" href="${pageContext.request.contextPath }/process/submitFlow">
                                                <i class="fa fa-download"></i> 导入新流程
                                            </a>
                                        </div>
                                    </div>
                                </div>

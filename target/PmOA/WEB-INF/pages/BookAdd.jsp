                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel-body">
                                    <form>
                                        <p>姓名：</p>
                                        <input type="text" class="form-control" placeholder="姓名" name="" id="bookName">
                                        <br>
                                        <p>邮箱：</p>
                                        <input type="text" class="form-control" placeholder="邮箱" name="" id="bookEmail">
                                        <br>
                                        <p>电话：</p>
                                        <input type="text" class="form-control" placeholder="电话" name="" id="bookPhone">
                                        <br>
                                        <p>隶属单位：</p>
                                        <input type="text" class="form-control" placeholder="隶属单位" name="" id="bookUnit">
                                        <br><br>
    ...
    $(function () {
        $("#submitForm").click(function () {
            ...
            $.ajax({
                ...
                type: "post",
                data: {"bookName":name, "bookUnit":unit, "bookPhone":phone, "bookEmail":email},
                dataType: "json"
            });
            alert("操作成功！");

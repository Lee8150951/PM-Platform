    ...
    <div class="main">
        ...
        <div class="main-content">
            ...
            <div class="container-fluid">
                <h3 class="page-title">招商引资档案信息录入</h3>
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="panel-body">
                                        <form action="" method="">
                                            ...
                                            <input type="text" class="form-control" placeholder="责任人" name="" id="fileDutyofficer">
                                            <br>
                                            <input type="text" class="form-control" placeholder="责任处室名" name="" id="fileResponse">
                                            <br>
                                            <input type="text" class="form-control" placeholder="档案题名" name="" id="fileTitle">
                                            <br>
                                            <p>档案写入时间：</p>
                                            <input type="date" class="form-control" name="" id="fileTime">
                                            <br><br>
                                            <div class="row">
                                                <div class="col-md-6"></div>
                                                <div class="col-md-3">
                                    ...
                                    <div class="panel-body">
                                        <form action="" method="">
                                            ...
                                            <div class="col-md-3" style="float: right;">
                                                <a type="submit" class="btn btn-success" id="submitFile">
                                                    <i class="fa fa-check-circle"></i>
                                                    上传
                                                </a>
                                            </div>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#submitForm").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath }/file/insertFile",

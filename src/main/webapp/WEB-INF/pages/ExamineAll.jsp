                            ...
                            <div class="col-md-12">
                                <div class="panel-body">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th style="text-align: center;">审批企业</th>
                                            <th style="text-align: center;">经办人</th>
                                            <th style="text-align: center;">审批机关</th>
                                        ...
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="examine">
                                            <tr>
                                                <td>${examine.examineId}</td>
                                                <td style="text-align: center;">${examine.examineEnterprise}</td>
                                                <td style="text-align: center;">${examine.examineMan}</td>
                                                <td style="text-align: center;">${examine.examineUnit}</td>
                                                <td style="text-align: center;"><fmt:formatDate value="${examine.examineTime}" pattern="yyyy-MM-dd"/></td>
                                                <td style="text-align: center;">${examine.examineResult}</td>
                                                <td style="text-align: center;">
                                                    <a href="" onclick="del(${examine.examineId})"><span class="label label-danger">删除</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>

                    ...
                    <li>
                        ...
                        <div id="emailManage" class="collapse in">
                            <ul class="nav">
                                ...
                                <li><a href="${pageContext.request.contextPath }/email/getAllGet" class="active">收信</a></li>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="email">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">${email.emailSend}</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/email/getAllGet?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/email/getAllGet?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/email/getAllGet?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/email/getAllGet?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message == true) {
            window.location.href = "${pageContext.request.contextPath }/email/deleteEmailByGet?emailId="+id;
            alert("删除成功");
        } else {
            alert("删除失败");
        }

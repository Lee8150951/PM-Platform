                    ...
                    <li>
                        ...
                        <div id="supportPolicy" class="collapse in">
                            <ul class="nav">
                                ...
                                <shiro:hasAnyRoles name="examine, leader" >
                                    <li><a href="${pageContext.request.contextPath }/examine/getList" class="active">已审批项目</a></li>
                                </shiro:hasAnyRoles>
                            </ul>
                        </div>
                    </li>
...
<div class="main">
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="page-title">待审批项目总览</h3>
                </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <select class="form-control" name="queryKind" id="queryKind">
                                        ...
                                        <option value="2">项目条例</option>
                                        <option value="5">申请时间</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center;">资金类别</th>
                                            <th style="text-align: center;">申请时间</th>
                                            <th style="text-align: center;">项目条例</th>
                                            <th style="text-align: center;">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${pageInfo.list}" var="policy">
                                            <tr>
                                                <td>${policy.policyId}</td>
                                                <td style="text-align: center;">${policy.policyEnterprise}</td>
                                                <td style="text-align: center;">${policy.policyMan}</td>
                                                <td style="text-align: center;">${policy.policyType}</td>
                                                <td style="text-align: center;"><fmt:formatDate value="${policy.policyApplytime}" pattern="yyyy-MM-dd"/></td>
                                                <td style="text-align: center;">${policy.policyPolicy}</td>
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/examine/examine?policyId=${policy.policyId}"><span class="label label-info">评估</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/examine/getAllUndone?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/examine/getAllUndone?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/examine/getAllUndone?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/examine/getAllUndone?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!-- 打印Excel -->

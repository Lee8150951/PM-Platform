        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-5" style="float: right">
                    <a class="btn btn-primary" href="${pageContext.request.contextPath }/book/skipInsert">
                        新建
                    </a>
                </div>
            </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="book">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">${book.bookUnit}</td>
                                                <td style="text-align: center;">${book.bookPhone}</td>
                                                <td style="text-align: center;">${book.bookEmail}</td>
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/book/getBook?bookId=${book.bookId}"><span class="label label-info">修改</span></a>
                                                    <a href="" onclick="del(${book.bookId})"><span class="label label-danger">删除</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/book/getAllInfo?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/book/getAllInfo?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/book/getAllInfo?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/book/getAllInfo?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message == true) {
            window.location.href = "${pageContext.request.contextPath }/book/deleteBook?bookId="+id;
            alert("删除成功");
        } else {
            alert("删除失败");
        }

                                        ...
                                        <c:forEach items="${pageInfo.list}" var="enterprise">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/assess/assessEnterprise?enterpriseId=${enterprise.enterpriseId}"><span class="label label-info">评估</span></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/assess/getToEvaluate?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/assess/getToEvaluate?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/assess/getToEvaluate?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/assess/getToEvaluate?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!-- 打印Excel -->

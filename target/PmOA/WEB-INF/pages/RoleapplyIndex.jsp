...
<div class="main">
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="page-title">角色申请信息总览</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="user">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/roleapply/detail?id=${user.id}"><span class="label label-primary">详情</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/roleapply/getAllInfo?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/roleapply/getAllInfo?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/roleapply/getAllInfo?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/roleapply/getAllInfo?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!-- 打印Excel -->

                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="examine">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">${examine.examinePrincipal}</td>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="${pageContext.request.contextPath }/check/insertCheck?examineId=${examine.examineId}"><span class="label label-primary">审阅</span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    <li><a href="${pageContext.request.contextPath }/check/getAllInfo?pn=1">首页</a></li>
                                                    <c:if test="${pageInfo.hasPreviousPage }">
                                                        <li><a href="${pageContext.request.contextPath }/check/getAllInfo?pn=${pageInfo.pageNum-1}"
                                                    ...
                                                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                                        ...
                                                        <c:if test="${page_Num != pageInfo.pageNum }">
                                                            <li><a href="${pageContext.request.contextPath }/check/getAllInfo?pn=${page_Num }">${page_Num }</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath }/check/getAllInfo?pn=${pageInfo.pages}">末页</a></li>
                                                </ul>
                                            </nav>
                                        </div>
